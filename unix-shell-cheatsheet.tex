...
\command{\textbf{cat}  \emph{<file>}}				{}
\command{\textbf{head} \emph{<file>}}				{}
\command{\textbf{tail} \emph{<file>}}				{}
\command{\textbf{less} \emph{<file>}}				{}
...
\command{\textbf{*}}						{wildcard (any file)}
\command{\textbf{*.txt}}					{any file ending in .txt}
\command{\textbf{data*}}					{any file starting with data}
